...
class BatchProcessor:
    ...
    @staticmethod
    def reshape_for_processing(tensor: torch.Tensor, preserve_alpha: bool = True) -> tuple[np.ndarray, np.ndarray | None, tuple]:
        """
        ...
        _batch_size, _height, _width, channels = original_shape
    ...
    @staticmethod
    def reshape_from_processing(processed_rgb: np.ndarray, alpha_channel: np.ndarray | None,
        ...
        """
        batch_size, height, width, _original_channels = original_shape
    ...
    def normalize_batch_range(tensor: torch.Tensor, target_min: float = 0.0, target_max: float = 1.0,
                            source_min: float | None = None, source_max: float | None = None) -> torch.Tensor:
        """
